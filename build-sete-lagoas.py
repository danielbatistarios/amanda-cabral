...
replacements = {
    ...
    '{{FOTO_CIDADE}}':       'sete-lagoas-lagoa-paulino.jpg',
    '{{ALT_FOTO_CIDADE}}':   'Lagoa Paulino, cartão-postal de Sete Lagoas, MG',
    '{{CAPTION_FOTO_CIDADE}}': 'Lagoa Paulino, Sete Lagoas, MG',
